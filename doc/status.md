...
*   **Описание:** Задачи P2.1, P2.2. Реализован механизм Paywall. Создан хук `useSubscription` для проверки уровня доступа. Создан компонент `Paywall` для блокировки контента. Механизм применен на странице `ExclusivesPage` для демонстрации работы.
